...
app.use("/images", express_1.default.static("upload/images"));
app.post("/upload", upload.single("product"), function (req, res) {
    var _a;
    console.log("it is working or not");
    res.json({
        success: 1,
        image_url: "http://localhost:".concat(port, "/images/").concat((_a = req.file) === null || _a === void 0 ? void 0 : _a.filename),
    });
});
